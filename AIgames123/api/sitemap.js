...
const STATIC_ROUTES = [
    ...
    { path: '/blog/save-game-progress-localstorage',         priority: 0.8, changefreq: 'monthly' },
    { path: '/blog/why-players-quit-your-game',              priority: 0.8, changefreq: 'monthly' },
    { path: '/blog/add-high-score-leaderboard',              priority: 0.8, changefreq: 'monthly' },
    { path: '/blog/30-minute-ai-game-challenge',             priority: 0.8, changefreq: 'monthly' },
    { path: '/blog/history-of-browser-games',                priority: 0.8, changefreq: 'monthly' },
